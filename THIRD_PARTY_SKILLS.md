...
This file records reviewed external skill sources and the staged rollout policy for
the Teamobi 2026 NRO server repository. It is not an installation script.

## Current State

- Rollout stage: **Stage 0 - guardrails established**.
- Third-party skills installed by this rollout: **none**.
- Installation scope for future stages: project-local `.agents/skills` only.
...
| --- | --- | --- | --- | --- |
| `addyosmani/agent-skills` | `48cb1168aeaaa70dfc2bbf709eddfa2a8ed8129a` | MIT | Selected review, security, simplification, TDD, and observability skills | Reviewed; not installed |
| `obra/superpowers` | `b36e0829c6d0140e93cfef2ca599b1b07d4a7797` | MIT | `systematic-debugging` only | Reviewed; not installed |
...
- Inspect every downloaded file and relative reference.
- Confirm no executable hooks, binaries, package lifecycle scripts, or unreviewed
...
- Confirm repository-specific NRO skills retain workflow ownership.
