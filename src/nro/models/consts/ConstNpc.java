...
public class ConstNpc {
    ...
    public static final byte KANAO = 112;
    public static final byte NGU_DAN = 113;
    //----------------------index menu------------------------------------------
    ...
    public static final int MENU_NANG_CAP_TRANG_BI = 518;
    //index menu whis
    ...
    public static final int KANAO_QUEST_MENU = 1015;
