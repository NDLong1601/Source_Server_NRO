...
COSTUME_WORKSPACE_ROOT = SCRIPTS_ROOT.parent
PROJECT_ROOT = COSTUME_WORKSPACE_ROOT.parent.parent
ICON_ROOT = PROJECT_ROOT / "data" / "icon"
PROJECTS_ROOT = COSTUME_WORKSPACE_ROOT / "projects"
...
def create_sql_for_specs(specs: Iterable[CostumeSpec], install_path: Path, rollback_path: Path) -> None:
    ...
    install = (
        "-- Install Marvel/hero costumes generated by tools/costumes/scripts/build_marvel_costumes.py\n"
        "SET NAMES utf8mb4;\n"
        "START TRANSACTION;\n\n"
    ...
    rollback = (
        "-- Roll back Marvel/hero costumes generated by tools/costumes/scripts/build_marvel_costumes.py\n"
        "SET NAMES utf8mb4;\n"
        "START TRANSACTION;\n\n"
        "DELETE FROM item_shop_option WHERE item_shop_id IN "
        f"(SELECT id FROM item_shop WHERE tab_id = {TAB_ID} AND temp_id IN ({item_id_csv}));\n"
