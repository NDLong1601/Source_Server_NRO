...
COSTUME_WORKSPACE_ROOT = PROJECT_DIR.parent.parent
REAL_REPOSITORY_ROOT = COSTUME_WORKSPACE_ROOT.parent.parent
REPOSITORY_ROOT = Path(os.environ.get("NRO_COSTUME_OUTPUT_ROOT", PROJECT_DIR / "staging-root")).resolve()
sys.path.insert(0, str(COSTUME_WORKSPACE_ROOT / "scripts"))
