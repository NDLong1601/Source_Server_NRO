...
- BODY frame đang dùng: `25043`, `25044`, `25046..25055`, `25057..25059`;
- BODY `[2]`, `[13]` và `[16]` cùng dùng animation `25059` theo yêu cầu;
...
BODY = [[25043,-9,-36],[25044,-20,-33],[25059,-15,-22],[25046,-12,-17],[25047,-15,-24],[25048,-15,-27],[25049,-15,-36],[25050,-11,-18],[25051,-11,-33],[25052,-11,-33],[25053,-11,-26],[25054,-10,-34],[25055,-11,-36],[25059,-15,-22],[25057,-11,-31],[25058,-19,-36],[25059,-15,-22]]
...
| 2 | 25059 | `walk_1[2]` | Lướt cực nhanh kèm bóng mờ và vệt xanh | Bay theo yêu cầu |
...
| 13 | 25059 | `walk_1[2]` | Lướt cực nhanh kèm bóng mờ và vệt xanh | Bay thay thế theo yêu cầu |
...
- Bay: BODY `[2]` hoặc `[13]`, cùng dùng animation `25059`.
...
- `use-25059-for-fly.sql`: ánh xạ cả hai slot bay về animation `25059`.
- `rollback-use-25059-for-fly.sql`: trả mapping bay về `25045/25056`.
...
- `backup-fly-alt-before-v2/`: image `25056` x1-x4 và DATA trước khi sửa nhánh bay
  thay thế BODY `[13]`.
- `backup-fly-dash-before-v3/`: manifest, SQL, DataGame và binary part trước khi dùng
  animation `25059` cho cả hai slot bay.
