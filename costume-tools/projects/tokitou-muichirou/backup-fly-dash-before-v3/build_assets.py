...
BODY_MAPPING = (
    ...
    ("fly", 1, "Bay ngang, tóc và vệt gió kéo dài", "Bay / nhảy"),
    ...
    ("fall", 2, "Tư thế bay lùi/ngã ngửa trên không, mắt nhắm", "Bay thay thế / ngã / đánh văng"),
...
BODY_IMAGE_IDS = tuple(range(25043, 25060))
